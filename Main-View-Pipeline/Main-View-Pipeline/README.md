...
This folder defines all source code for the 'Main-View-Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_main_view_pipeline.sql" to get familiar with the syntax.
